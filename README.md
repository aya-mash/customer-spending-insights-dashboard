...
# Initialize MSW (Mock Service Worker) - required for first-time setup
npx msw init public
...
> **Note**: The `mockServiceWorker.js` file in the `public/` directory is auto-generated by MSW and should not be committed to version control. Run `npx msw init public` after installing dependencies to generate it locally.
